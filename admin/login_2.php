...
<head>
  ...
  <body themebg-pattern="theme1">
                    ...
                    <!-- Authentication card start -->
						...
						<?php 
							if(isset($_POST['sbt'])){
								...
								$rawselect="select * from admin where user_name='%s'&&password='%s'&&id=1;";
								$select=sprintf($rawselect,mysqli_real_escape_string($db,$user_name),mysqli_real_escape_string($db,$password));
								...
								if($count>0){
									...
									$alert_content='User Name or Password Not Match ';
								}
							}
						?>
                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <input type="submit" value="submit" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20" name="sbt"/>
                                        </div>
                                    </div>
                                    <hr/>
                                    <div class="row">
	...
	<div class="alert" style="<?php echo $alert_display?>;top:0;">
