		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav">
				...
				<ul class="dropdown-menu">
					...
					?>
					<li class="dropdown-menu-2"><a href="../product/?c=<?php echo $category?>&&cc=<?php echo $company?>" class="nav_border"><?php echo $company.'('.$company_count.')'?></a>
					<ul class="submenu">
						<li class="dropdown"><a href="#" class="nav_border">sub menu 1</a></li>
						<li class="dropdown"><a href="#" class="nav_border">sub menu 2</a></li>
						<li class="dropdown"><a href="#" class="nav_border">sub menu 3</a></li>
					</ul>
					</li>
					<?php }}?>
